/** Minimal inline brand marks (Lucide dropped brand icons in v1). */
...
export function LinkedinIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M6.94 5A2 2 0 1 1 3 5a2 2 0 0 1 3.94 0ZM3.25 8.5h3.5V21h-3.5V8.5Zm5.5 0h3.35v1.7h.05c.47-.85 1.6-1.75 3.3-1.75 3.53 0 4.18 2.24 4.18 5.15V21h-3.5v-5.55c0-1.32-.03-3.02-1.9-3.02-1.9 0-2.19 1.44-2.19 2.93V21h-3.49V8.5Z" />
    </svg>
  );
}
...
export function YoutubeIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M23 12s0-3.2-.41-4.73a2.47 2.47 0 0 0-1.74-1.74C19.32 5.12 12 5.12 12 5.12s-7.32 0-8.85.41A2.47 2.47 0 0 0 1.41 7.27C1 8.8 1 12 1 12s0 3.2.41 4.73a2.47 2.47 0 0 0 1.74 1.74c1.53.41 8.85.41 8.85.41s7.32 0 8.85-.41a2.47 2.47 0 0 0 1.74-1.74C23 15.2 23 12 23 12ZM9.75 15.02V8.98L15 12l-5.25 3.02Z" />
    </svg>
  );
}

/** Full-colour Google "G" for auth buttons. */
